...
export class PriceListService {
  ...
  private readonly _mockPriceList: BehaviorSubject<Price[]> = new BehaviorSubject<Price[]>([
    {
      "id": '1',
      "imageUrl": 'https://res.cloudinary.com/dfv7maike/image/upload/v1739555476/makijaz-biznesowy_e5red1.jpg',
      "price": 160,
  ...
  getAll(): Observable<Price[]> {
    return this._mockPriceList.asObservable();
  }
}